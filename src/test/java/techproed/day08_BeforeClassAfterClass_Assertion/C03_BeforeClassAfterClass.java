...
public class C03_BeforeClassAfterClass {
    ...
    public void setUp() throws Exception {//test01 methodundan önce 1 kez çalıştı
        ...
        //burdaki ayarlar beforeClass ta olsaydi sadece bir kez calistigi icin tes1 calisir,test2 calismaz
    }
    ...
    @AfterClass
    public static void tearDown() throws Exception {//en son bir kez AfterClass methodu çalıştığı için son açılan browser(developer) kapandı,qa acik kaldi
        driver.close();
    }
